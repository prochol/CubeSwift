...
class PrimitiveCube: SCNNode {
    ...
    func sideBoxNodeX(_ sideColor: NSColor) -> SCNNode {
        // create and add a 3d box to the scene
        let boxNode = self.sideBoxNodeX()
    ...
    func sideBoxNodeY(_ sideColor: NSColor) -> SCNNode {
        // create and add a 3d box to the scene
        let boxNode = self.sideBoxNodeY()
    ...
    func sideBoxNodeZ(_ sideColor: NSColor) -> SCNNode {
        // create and add a 3d box to the scene
        let boxNode = self.sideBoxNodeZ()
    ...
    func sideBoxNodeX() -> SCNNode {
        ...
        let sideBoxNode = SCNNode(geometry: SCNBox(width: 0.1, height: 0.9, length: 0.9, chamferRadius: 0.05))
        
        // create and configure a material
        let material = SCNMaterial()
        material.diffuse.contents = NSColor.gray
        material.specular.contents = NSColor.yellow
        material.locksAmbientWithDiffuse = true
    ...
    func sideBoxNodeY() -> SCNNode {
        ...
        let sideBoxNode = SCNNode(geometry: SCNBox(width: 0.9, height: 0.1, length: 0.9, chamferRadius: 0.05))
    ...
    func sideBoxNodeZ() -> SCNNode {
        ...
        let sideBoxNode = SCNNode(geometry: SCNBox(width: 0.9, height: 0.9, length: 0.1, chamferRadius: 0.05))
    ...
    func quaternionMultiply(_ quaternion1: SCNVector4, quaternion2: SCNVector4) -> SCNVector4 {
